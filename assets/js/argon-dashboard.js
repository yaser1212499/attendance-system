...
(function() {
  ...
  if (isWindows) {
    ...
    if (mainpanel) {
      try { new PerfectScrollbar(mainpanel); } catch(e) { /* ignore */ }
    }

    var sidebar = document.querySelector('.sidenav');
    if (sidebar) {
      try { new PerfectScrollbar(sidebar); } catch(e) { /* ignore */ }
    }

    var fixedplugin = document.querySelector('.navbar:not(.navbar-expand-lg) .navbar-collapse');
    if (fixedplugin) {
      try { new PerfectScrollbar(fixedplugin); } catch(e) { /* ignore */ }
    }

    var fixedplugin2 = document.querySelector('.fixed-plugin');
    if (fixedplugin2) {
      try { new PerfectScrollbar(fixedplugin2); } catch(e) { /* ignore */ }
    }
  }
})();
